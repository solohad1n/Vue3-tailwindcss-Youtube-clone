<template>
  <SidebarSection>
    <ul>
      <SidebarNavItem label="Home" icon="home" isActive/>
  ...
  <SidebarSection>
    <ul>
      ...
      <SidebarNavItem label="History" icon="musicNote"/>
    </ul>
  </SidebarSection>
...
<script setup>
import SidebarNavItem from '@/TheSidebar/SidebarNavItem.vue'
import ButtonLogin from '@/ButtonLogin/ButtonLogin.vue'
import SidebarSectionHeading from '@/TheSidebar/SidebarSectionHeading.vue'
import SidebarSection from '@/TheSidebar/SidebarSection.vue'
